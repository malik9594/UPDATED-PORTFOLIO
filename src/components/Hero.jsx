      ...
      z-0 right-2 top-28 rounded-3xl"
        >
          <figure
            data-aos="fade-up"
            data-aos-delay="500"
            class="flex-1 flex justify-center md:justify-end mt-0 aos-init aos-animate"
          >
            <img
              src={heroImage}
              alt="hero image"
              className="h-[350px] sm:h-[170px] md:h-[450px] w-[280px] sm:w-[480px] object-cover transform relative animate-move-horizontal"
            />
          </figure>
        </div>
      ...
      w-full px-4 md:px-52 pb-4 md:pb-24 md:pt-32 pt-24 md:mt-0 z-10"
        >
          ...
          >
            ...
            <header>
              <h1
                className="text-4xl sm:text-4xl md:text-5xl font-bold text-white mb-4"
              ...
              <h2
                className="text-xl sm:text-4xl md:text-2xl font-bold text-[#3e0f4a] md:text-[#c744ec] mb-2"
                style={{ paddingLeft: "1rem" }}
              >
            ...
            <p
              className="text-base sm:text-lg md:text-lg text-gray-200 mb-6"
              style={{ paddingLeft: "1rem" }}
            >
              Specialize in full-stack development with a strong focus on React,
              JavaScript, and modern styling tools like Tailwind CSS, Material
              UI, Bootstrap, Aceternity UI, and Chakra—paired with robust
              backend skills in Node.js, Express, REST/GraphQL APIs, and
            ...
            >
              <a href="https://github.com/malik9594" target="_blank">
                ...
                <FaGithub className="w-11 h-11 text-white" />{" "}
              </a>
              <a
                href="https://www.linkedin.com/in/hassan-raza-a83950219/"
                target="_blank"
              >
              ...
              <a
                href="https://www.facebook.com/hassan.raza.379053"
                target="_blank"
              >
